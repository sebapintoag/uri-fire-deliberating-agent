...
SAMPLE_RISK_ELEMENTS = ['wastes', 'dry grass', 'wood', 'papers', 'electric cables', 'liquefied gas', 'illegal electricity connection', 'fuel recipient', 'glass', 'glass bottle', 'bonfire', 'none']
SAMPLE_SURROUNDINGS = ['grass', 'dry grass', 'ground', 'trees', 'trash', 'house', 'tent', 'electric connection', 'fuel recipient', 'wood', 'nothing']
